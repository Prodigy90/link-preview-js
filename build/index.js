...
function getImages(doc, rootUrl, imagesPropertyType) {
    ...
    if (images.length <= 0 && rootUrl.indexOf("youtube.com") >= 0) {
        var videoId = new URL(rootUrl).searchParams.get('v') || rootUrl.split('/').pop();
        if (videoId) {
            videoId = videoId.split('?')[0];
            images.push("https://i.ytimg.com/vi/".concat(videoId, "/maxresdefault.jpg"));
        }
        else {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    _e.label = 2;
                case 2:
                    timeout = (_b = options === null || options === void 0 ? void 0 : options.timeout) !== null && _b !== void 0 ? _b : 3000;
                    controller = new abort_controller_1.default();
                    timeoutCounter = setTimeout(function () { return controller.abort(); }, timeout);
                    fetchOptions = {
                        headers: (_c = options === null || options === void 0 ? void 0 : options.headers) !== null && _c !== void 0 ? _c : {},
                        redirect: (_d = options === null || options === void 0 ? void 0 : options.followRedirects) !== null && _d !== void 0 ? _d : "error",
                ...
                case 8:
                    normalizedResponse = (_a.data = _e.sent(),
                        _a);
